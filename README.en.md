...
**`category-public-dns`** contains DoH resolvers by Google, Cloudflare and Apple: through them a client resolves domains on its own, so routing and blocking rules may not apply. With no access to them it falls back to the DNS from your config
